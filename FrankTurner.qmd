...
gigs |> group_by(gig_date) |> mutate(total_gigs_on_day = n()) |> arrange(desc(total_gigs_on_day))
...
gigs_main |> group_by(location_part_1) |> 
  summarise(n = n()) |> 
...
gigs_country_sum |> spread(gig_year, n, fill=NA) |> 
  ...
  guides(fill = FALSE) +
    labs(title="Frank Turner Solo Gigs by Country") +
